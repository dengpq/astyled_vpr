...
struct s_annealing_sched {
    ...
    float inner_num; /* used for controlling the move times in SA inner loop*/
    float init_t;  /* initial_temperature */
    float alpha_t; /* factor about descrease the temperature. */
    float exit_t;  /* exit_temperature */
};
